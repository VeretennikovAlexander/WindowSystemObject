...
Box.CustomDraw = true
Box.CustomDrawSelection = true

function OnDrawItem(Sender,Item)
{
	if (Item.Focused)
	{
		Item.TextBkColor = o.Translate("COLOR_HIGHLIGHT") | 0xFF000000
		Item.Font.Color = o.Translate("COLOR_HIGHLIGHTTEXT") | 0xFF000000
	} else
	if (Item.Selected)
	{
		Item.Brush.Style = o.Translate("B_CLEAR")
		Item.Font.Color = 0x00FF
		Item.Brush.Color = 0xFF
	}
	Item.Indent = (Item.Index % 5) * 10
}
